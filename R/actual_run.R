...
SS_real <- SS_real[[1]]
abc_cophy <- ABC_taxi(target = SS_real[SS_sel], param = para_sim_md[, c('lambda_H', 'lambda_S', 'lambda_C', 'exp_H', 'mu_H_frac', 'mu_S_frac')], sumstat = as.matrix(SS_sim_md)[, SS_sel], tol = perc) # 1:30 are column indices of the normalized BLenD
