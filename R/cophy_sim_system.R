...
ext_frac <- data.frame(
  ...
  mu_H_frac = runif(1, min = 0.7, max = 0.7), # here you can specify the upper limit of the extinction fraction - a high extinction fraction is perhaps more likely to lead to poor inference performance.
