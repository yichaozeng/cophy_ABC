...
if(SMC == 'zero'){
  file_name <- paste(prefix, "cophy_ABC_sims_0/", as.character(folder_id_slash), "sim_", as.character(sim_id), ".rds", sep = '')
  folder_path <- paste(prefix, "cophy_ABC_sims_0/", as.character(folder_id), sep = '')
}else if(SMC == 0){
  ...
  file_name <- paste(prefix, "cophy_ABC_sims_SMC/", as.character(folder_id_slash), "sim_", as.character(sim_id), ".rds", sep = '')
  folder_path <- paste(prefix, "cophy_ABC_sims_SMC/", as.character(folder_id), sep = '')
}else if(SMC == 2){
  file_name <- paste(prefix, "cophy_ABC_sims_SMC_2/", as.character(folder_id_slash), "sim_", as.character(sim_id), ".rds", sep = '')
  folder_path <- paste(prefix, "cophy_ABC_sims_SMC_2/", as.character(folder_id), sep = '')
}else if(SMC == 3){
  file_name <- paste(prefix, "cophy_ABC_sims_SMC_3/", as.character(folder_id_slash), "sim_", as.character(sim_id), ".rds", sep = '')
  folder_path <- paste(prefix, "cophy_ABC_sims_SMC_3/", as.character(folder_id), sep = '')
}else if(SMC == 4){
  file_name <- paste(prefix, "cophy_ABC_sims_SMC_4/", as.character(folder_id_slash), "sim_", as.character(sim_id), ".rds", sep = '')
  folder_path <- paste(prefix, "cophy_ABC_sims_SMC_4/", as.character(folder_id), sep = '')
}
...
# we need to take into account the size of the cophylogeny when computing the SSs
# here we consider one size class as a example, 
